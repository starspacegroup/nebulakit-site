...
describe('Admin Auth Keys Page', () => {
	...
	it('should render the page title', () => {
		render(AuthKeysPage, { props: { data: { user: mockUser, canRevealPii: false, canViewStats: false, piiRevealed: false, hasAIProviders: false, cmsPaletteItems: [], gaMeasurementId: null, canManageAnalytics: false, keys: [] } } });
	...
	it('should render a list of existing keys', () => {
		...
		render(AuthKeysPage, {
			props: { data: { user: mockUser, canRevealPii: false, canViewStats: false, piiRevealed: false, hasAIProviders: false, cmsPaletteItems: [], gaMeasurementId: null, canManageAnalytics: false, keys: mockKeys } }
		});
